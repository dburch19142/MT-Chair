...
class UpdateBGScreen extends StatefulWidget {
  const UpdateBGScreen({super.key});

  @override
  State<UpdateBGScreen> createState() => _UpdateBGScreenState();
}

class _UpdateBGScreenState extends State<UpdateBGScreen> {
  ...
  void addBarber() async {
    ...
    try {
      ...
      bool res = await DatabaseService.updateBg(file: file!);
