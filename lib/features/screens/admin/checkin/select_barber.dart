...
class CheckInBarberScreen extends StatefulWidget {
  const CheckInBarberScreen({super.key});

  @override
  State<CheckInBarberScreen> createState() => _CheckInBarberScreenState();
}
                              ...
                              return snapshot.data!.docs.isEmpty
                                  ...
                                  : GridView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        return InkWell(
                                          onTap: () {
                                            Get.toNamed(AppPages.checkList,
                                                arguments: {
                                                  'barberId': data[index]['id'],
                                                  'barberName': data[index]
                                                      ['name']
                                                });
                                          },
                                          child: Container(
